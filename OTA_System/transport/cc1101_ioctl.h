 ...
 *
 * [gateway-ota 쪽 사본, 2026-08-11] kernel-cc1101-spi/cc1101_ioctl.h와 반드시
 * 내용이 같아야 하는 계약 헤더입니다 (ota_protocol.h가 gateway-ota·firmware-esp32
 * 사이의 계약인 것과 같은 구조). 커널 쪽 헤더가 바뀌면 이 파일도 같이 갱신해야 합니다.
 */
