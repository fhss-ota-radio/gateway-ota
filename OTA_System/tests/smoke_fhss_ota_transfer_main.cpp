...
// [2026-08-25 이동, feature/qt-fhss-transfer] SlotAwareTransport는
// transport/slotawaretransport.h/.cpp로 옮겼다 — otamanager.cpp(Qt 화면)도
// 같은 구현체를 재사용하기 위해서다. 상세: transport/slotawaretransport.h
// 상단 주석 참고.
